    ...
    <div>
      <div className=" rounded-lg flex align-middle items-center bg-white justify-between mb-[25px]">
        <div className="flex items-center gap-5">
          <img className="w-[100px] h-[100px] my-5 ml-5 rounded-lg" src="../public/pizzaBanner.jpeg" alt="" />
          <div className="flex flex-col justify-start items-start ">
            <h1 className="text-xl font-bold">Vegan veggie</h1>
            <p className="py-3 text-sm italic" >Daiya vegan pizza, paired with fresh veggies</p>
